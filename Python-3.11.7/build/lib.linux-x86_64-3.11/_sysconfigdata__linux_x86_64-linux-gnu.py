...
build_time_vars = {'ABIFLAGS': '',
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/tim/kenya-polio-vaccine-hesitancy/Python-3.11.7/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/tim/kenya-polio-vaccine-hesitancy/Python-3.11.7/lcov-report',
 ...
 'PY_CORE_CFLAGS': '-Wsign-compare -DNDEBUG -g -fwrapv -O3 -Wall '
                   ...
                   '-fprofile-generate -I./Include/internal -I. -I./Include '
                   '-DPy_BUILD_CORE',
 'PY_CORE_LDFLAGS': '-fno-semantic-interposition -fprofile-generate',
 'PY_CPPFLAGS': '-I. -I./Include',
 'PY_ENABLE_SHARED': 0,
 'PY_FORMAT_SIZE_T': '"z"',
 'PY_LDFLAGS': '',
 'PY_LDFLAGS_NODIST': '-fno-semantic-interposition -fprofile-generate',
 'PY_LDFLAGS_NOLTO': '-fprofile-generate',
 ...
 'abs_builddir': '/home/tim/kenya-polio-vaccine-hesitancy/Python-3.11.7',
 'abs_srcdir': '/home/tim/kenya-polio-vaccine-hesitancy/Python-3.11.7',
